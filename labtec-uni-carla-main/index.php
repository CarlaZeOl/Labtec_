...
switch ($action) {
  ...
  // COMPRA_PROVEEDOR //
  case 'NewCP':
    include_once 'api/controllers/controllerComp_Prov.php';
    $controller = new controllerComp_Prov();
    $result = $controller->Register($_REQUEST);
    if($result){
        echo json_encode(["status" => true, "message" => "DATA_SAVED"]);
    } else{
...
// COMPRA_PROVEEDOR //
 ...
 // PEDIDO_PRODUCTO //
 case 'NewPP':
    include_once 'api/controllers/controllerPedi_Prod.php';
    $controller = new controllerPedi_Prod();
    $result = $controller->Register($_REQUEST);
    if($result){
        echo json_encode(["status" => true, "message" => "DATA_SAVED"]);
    } else{
